...
**Regulation V** | 12 CFR Part 222 | Current as of 2026-03-09
  ...
  ( b ) Definitions. For purposes of this subpart:
    ...
    ( 4 ) Pre-existing business relationship —
      ...
      ( iii ) Examples where no pre-existing business relationship is created.
        ...
        ( A ) If a consumer makes a telephone call to a centralized call center for a group of affiliated companies to inquire about the consumer's existing account at a depository institution, the call does not constitute an inquiry to any affiliate other than the depository institution that holds the consumer's account and does not establish a pre-existing business relationship between the consumer and any affiliate of the account-holding depository institution.
...
## § 222.73 Content, form, and timing of risk-based pricing notices.
  ...
  ( b ) Form of the notice —
    ...
    ( 1 ) In general. The risk-based pricing notice required by § 222.72(a) , (c) , or (d) must be:
...
## § 222.74 Exceptions.
  ...
  ( c ) Prescreened solicitations —
    ...
    ( 1 ) In general. A person is not required to provide a risk-based pricing notice to the consumer under § 222.72(a) or (c) if the person:
  ...
  ( d ) Loans secured by residential real property—credit score disclosure —
    ...
    ( 1 ) In general. A person is not required to provide a risk-based pricing notice to a consumer under § 222.72(a) or (c) if:
  ...
  ( f ) Credit score not available —
    ...
    ( 1 ) In general. A person is not required to provide a risk-based pricing notice to a consumer under § 222.72(a) or (c) if the person:
