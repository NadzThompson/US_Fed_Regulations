# Supervisory Letter SR 99-24 (SUP) on loan write-up standards for assets criticized during examinations--September 29, 1999
...
**Topic:** SUP
**Source:** [https://www.federalreserve.gov/boarddocs/srletters/1999/SR9924.HTM](https://www.federalreserve.gov/boarddocs/srletters/1999/SR9924.HTM)
...
A general description of the obligation:
...
Guarantors and a brief description of their ability to act as a source of repayment, especially if their financial strength has changed significantly since the initial guarantee of the credit facility (Refer to
SR letter 91-24
for additional guidance in considering guarantees for credit analysis purposes.)
...
A summary listing of weaknesses resulting in classification or special mention treatment.
A reference to any identified deficiencies in the item which will support loan administration or violation comments elsewhere in the report.
If management disagrees with the classification, a statement to that effect along with management's rationale.
A concise description of management action taken or planned to address the weakness in the asset.
